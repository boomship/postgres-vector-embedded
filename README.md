...
| Windows  | x64         | ✅ Supported | SSL, ICU, LZ4, ZSTD, XML, UUID |

> **Windows Full Variant**: Now available with advanced features including SSL/TLS encryption, advanced compression, XML processing, and UUID generation.
